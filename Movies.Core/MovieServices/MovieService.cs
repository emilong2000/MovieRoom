...
namespace Movies.Core.Services
{
    public class MovieService : IMovieService
    {
        ...
        public async Task<ApiResponse> CreateMovie(MovieRequest model)
        {
            try
            {
        ...
        public async Task<ApiResponse> DeleteMovie(int Id)
        {
            try
            {
                ...
                if (response > 0)
                {
                    ...
                    return new ApiResponse { ResponseCode = APiResponseCode.Successful, StatusCode = APiResponseCode.StatusOk, Message = "successful" };
                }
                else
                {
        ...
        public async Task<ApiResponse> EditMovie(MovieUpdateRequest model)
        {
            try
            {
                var mapper = _mapper.Map<Movie>(model);
        ...
        public async Task<ApiResponse> GetAllMovies()
        {
            ...
            try
            {
                ...
                return new ApiResponse { ResponseCode = APiResponseCode.Successful, StatusCode = APiResponseCode.StatusOk, Message = "successful", Data = MovieList };
            }
            catch (Exception ex)
            {
